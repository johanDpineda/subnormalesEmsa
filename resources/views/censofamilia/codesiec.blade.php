<div wire:ignore.self  class="modal fade" id="codigosiec"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content p-3 p-md-5">
            ...
            <div class="modal-body">
                ...
                <div class="text-center mb-4">
                    <h3 class="mb-2">{{__('siec code')}}</h3>
                    <p class="text-muted">{{__('Fill in the information for the siec code')}}</p>
                </div>
                ...
                @if($codigosiecsub)
                    @livewire("censo.codesiec", ['codigosiecsub' => $codigosiecsub])
                @endif
