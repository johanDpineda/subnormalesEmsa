                        ...
                        <div class="dt-buttons btn-group flex-wrap">
                            <button class="dt-button add-new btn btn-primary" data-bs-toggle="modal" data-bs-target="#create">
                                <span>
                                  ...
                                  <span class=" d-sm-inline-block">{{__('Add user')}}</span>
                                </span>
                            </button>
                        </div>
                    </div>
                    ...
                    <table class="table">
                        ...
                        @forelse($users as $user)
                            <tr>
                                <td class="text-center">
                                    @if($user->image!=null)
                                        <div class="avatar-wrapper d-flex justify-content-center">
                                            <div class="avatar avatar-lg p-2 rounded-circle bg-label-primary">
                               ...
                               <!-- livewire/users/show.blade.php -->

                                <!-- livewire/users/show.blade.php -->

                                <td class="text-center">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" wire:click="toggleActivo({{ $user->id }})" {{ $user->activo ? 'checked' : '' }} id="flexSwitchCheckChecked_{{ $user->id }}">
                                        <label class="form-check-label" for="flexSwitchCheckChecked_{{ $user->id }}">
                                ...
                                <td class="text-center">
                                    <div class="d-inline-block text-nowrap">
                                        <button class="btn btn-sm btn-icon edit-record" data-bs-toggle="modal" data-bs-target="#edituser" wire:click="edituser({{$user->id}})">
