<div>
    <form class="row g-3" wire:submit.prevent="save">
        ...
        <div class="col-12">
            <label class="form-label" for="file_name_acuerdoemsa">* {{__('Emsa Agreement')}}:</label>
            <input type="file" wire:model="file_name_acuerdoemsa" class="form-control">
            @error('file_name_acuerdoemsa')
