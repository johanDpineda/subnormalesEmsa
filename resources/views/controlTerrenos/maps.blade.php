                ...
                <div class="modal-body">
                    ...
                    <div class="card">
                        @if ($selectedCaminante)
                            <iframe class="cardmap-movil" src='https://www.google.com/maps?q={{ $selectedCaminante->Datoscaminante->latitude ?? "" }},{{ $selectedCaminante->Datoscaminante->longitude ?? "" }}&hl=es;z=14&output=embed' frameborder="0" width="450" height="450"></iframe>
