<div wire:ignore.self  class="modal fade" id="cargarAcuerdo"  tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="modal-content p-3 p-md-5">
            ...
            <div class="modal-body">
                ...
                <div class="text-center mb-4">
                    <h3 class="mb-2">{{__('Add Document Emsa agreement')}}</h3>
                    <p class="text-muted">{{__('Complete the information to add the Emsa agreement')}}</p>
                </div>



                @if($docacuerdoemsaa)
                    @livewire("crear-subnormal.archivoacuerdoemsa", ['docacuerdoemsaa' => $docacuerdoemsaa])
                @endif
