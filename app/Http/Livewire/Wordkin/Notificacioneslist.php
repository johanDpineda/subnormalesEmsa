...
class Notificacioneslist extends Component
{
    ...
    protected $listeners = ['actualizarContadorNotificaciones'];

    public function actualizarContadorNotificaciones()
    {
        // Lógica para cargar el nuevo conteo de notificaciones
        $this->cargarNotificacionesLeidas();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.wordkin.notificacioneslist', [
